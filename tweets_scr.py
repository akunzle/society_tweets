...
chrome_driver = webdriver.Chrome("/Users/andreakunzle/.pyenv/versions/3.10.0/lib/python3.10/site-packages/selenium/webdriver/chrome/chromedriver")

# open the browser and maximize the window
chrome_driver.maximize_window()

chrome_driver.get('https://twitter.com/login')
...
username.send_keys('stefaniamendesm')
...
#    EC.element_to_be_clickable((By.CSS_SELECTOR, '[name="text"]'))
#)
#verify_username.send_keys('stefaniamendesm')
...
my_password.send_keys('thestefcards')
...
search_input.send_keys('(inteligencia artificial) until:2022-12-31 since:2018-01-01 geocode:-25.274398,-57.634666,100km')
...
keyterms = ['inteligencia artificial', 'internet', 'digital', 'cripto', 'tecnologia', 'innovacion', 'virtual', 'automatizacion', 'IoT', 'big data', 'realidad aumentada', 'virtual', 'robot', 'fibra optica', 'ciber', 'mitic', 'conacyt', 'empresas tics', 'inteligentes', 'algoritmo', 'codificacion', 'conectividad', 'centro de datos']

formatted_keyterms = []

for keyterm in keyterms:
    formatted_keyterm = f"({keyterm}) until:2022-12-31 since:2018-01-01 geocode:-25.274398,-57.634666,100km"
    formatted_keyterms.append(formatted_keyterm)

print(formatted_keyterms)
...
# saving the tweet 
with open('internet_tweets.csv','w',newline='', encoding='utf-8') as f:
...
# saving the tweet 
with open('internet_tweets.csv', 'a', newline='', encoding='utf-8') as f:
    header = ['username','handle','postDate','responding','retweets','likes']
    writer = csv.writer(f)
